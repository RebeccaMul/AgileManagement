<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sprintDevelopersAdd.aspx.cs" Inherits="addSprint" %>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <%----RME SQL Statement to show available developers in a sprint--- %>
                            ...
                            <asp:SqlDataSource ID="AvailableBacklog" runat="server" ConnectionString='<%$ ConnectionStrings:dbconnect %>'
                                SelectCommand="SELECT SCRUM_TEAM.*, SCRUM_USERS.firstName, SCRUM_USERS.lastName, SCRUM_ROLE.roleTitle FROM SCRUM_TEAM INNER JOIN SCRUM_PROJECT ON SCRUM_TEAM.projectID = SCRUM_PROJECT.projectID INNER JOIN SCRUM_ROLE ON SCRUM_TEAM.roleID = SCRUM_ROLE.roleID INNER JOIN SCRUM_USERS ON SCRUM_TEAM.userID = SCRUM_USERS.userID WHERE SCRUM_PROJECT.projectID = @ID AND SCRUM_TEAM.roleID = '3'">
                                <SelectParameters>
                            ...
                            <div class="panel-heading">
                                <svg class="glyph stroked open folder">
                                    <use xlink:href="#stroked-open-folder"></use></svg>
                                <b>Available Developers for Sprint:</b>
                            </div>
                            <br />
                            <br />
                            ...
                            <asp:ListView ID="UserStories" runat="server" DataSourceID="AvailableBacklog" DataKeyNames="teamID">
                                ...
                                <br />
                                    <asp:HyperLink ID="AddMemberLink" runat="server" class="btn btn-primary" NavigateUrl='<%# "sprintDevelopersAdd.aspx?userID=" + Eval("userID") %>'>Add</asp:HyperLink>
