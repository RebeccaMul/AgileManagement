<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewstorypoints.aspx.cs" Inherits="AddStoryPoints" %>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
                ...
                <li class="ative">View Story Points</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">View Story Point </h1>
		...
		<div class="row">
            ...
            <%-- SM - Displays unique User Story's Details  --%>
          ...
          <asp:Label ID="Label5" runat="server" Text='<%# Eval("value") %> ' />
           ...
           <br />
            ...
            <%-- SM - Displays unique Story Point for each User Story  --%>
           
            <asp:SqlDataSource ID="story" runat="server" ConnectionString='<%$ ConnectionStrings:dbconnect %>' SelectCommand="SELECT SCRUM_STORY_POINTS.storypoint, SCRUM_STORY_OPTIONS.value
            FROM SCRUM_STORY_POINTS 
            INNER JOIN SCRUM_STORY_OPTIONS ON
            SCRUM_STORY_POINTS.options = SCRUM_STORY_OPTIONS.optionID
            INNER JOIN SCRUM_BACKLOG ON
            SCRUM_STORY_POINTS.BacklogID = SCRUM_BACKLOG.ID WHERE SCRUM_BACKLOG.ID = @BID">

                         <SelectParameters>
                    <asp:QueryStringParameter QueryStringField="BacklogID" Name="BID" Type="Int32"></asp:QueryStringParameter>
                </SelectParameters>
            </asp:SqlDataSource>

                        <br /><b>Points for this Story</b>
                        <br />


                        <asp:ListView ID="ListView1" runat="server" DataSourceID="story">

                            <ItemTemplate>

        <%-- SM - Displays Story Point  --%>
                              
        <br />  <asp:Label ID="value" runat="server" Text='<%# Eval("value") %> ' /> <br />
			 ...
			 <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString='<%$ConnectionStrings:dbconnect %>' SelectCommand="SELECT * FROM SCRUM_BACKLOG WHERE (SCRUM_BACKLOG.ID = @id)">  
