<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManageTeamAdd.aspx.cs" Inherits="ManageTeam" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
            ...
            <div class="row">
                ...
                <%--Data Source to Select Users Within Project and Scrum Te:--%>
                ...
                <%--Data Source to Select Select Scrum Roles from the Database:--%>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <svg class="glyph stroked clipboard-with-paper">
                            <use xlink:href="#stroked-clipboard-with-paper"></use></svg>Manage Team</div>
                    <div class="panel-body">


                        <%--Role Selection Dropdown:--%>
                        <label class="col-md-3 control-label" for="name">Assign a Role:</label><br />
                        <br />
                        <br />
                        <asp:DropDownList ID="RoleList" runat="server" DataSourceID="RoleDetails" DataTextField="roleTitle" DataValueField="roleID"></asp:DropDownList>


                        <%--Update Button:--%>
                        <asp:Button ID="Update" runat="server" Text="Update" OnClick="UpdateBtn_Click" />
