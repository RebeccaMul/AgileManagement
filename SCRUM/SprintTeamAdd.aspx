<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SprintTeamAdd.aspx.cs" Inherits="SprintTeamAdd" %>
		...
		<div class="row">
            ...
            <asp:SqlDataSource ID="UserDetails" runat="server" ConnectionString='<%$ ConnectionStrings:dbconnect %>' SelectCommand="SELECT * FROM SCRUM_USERS WHERE 
                ...
                <asp:QueryStringParameter QueryStringField="searchquery" Name="EmailAdd"></asp:QueryStringParameter>
                    ...
                    <div class="panel panel-default">
                    <div class="panel-heading"><svg class="glyph stroked clipboard-with-paper"><use xlink:href="#stroked-clipboard-with-paper"></use></svg>Create Project Team</div>
