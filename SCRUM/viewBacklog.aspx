<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewBacklog.aspx.cs" Inherits="viewBacklog" %>
            ...
            <div class="panel panel-default chat">
                <div class="panel-heading" id="accordion">
                    <svg class="glyph stroked two-messages">
                        <use xlink:href="#stroked-app-window-with-content"></use></svg><b> Product Backlog</b>
                </div>
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <br />
                        <br />
                        <label for="valueinput" class="col-sm-2 control-label">Value: </label>
                        <div class="col-sm-10">
              ...
              <%-- SM - Display Story Points options --%>
                        ...
                        <label for="storypointinput" class="col-sm-2 control-label">Story Points: </label>
