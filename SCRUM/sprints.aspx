<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sprints.aspx.cs" Inherits="sprints" %>
...
<a href="#" class="dropdown-toggle" data-toggle="dropdown"><svg class="glyph stroked eye"><use xlink:href="#stroked-eye"></use></svg> <asp:Label ID="username" runat="server" Text=""></asp:Label><span class="caret"></span></a>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
       ...
       <div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">View a Sprint</h1>
			</div>
		</div><!--/.row-->
   ...
   <asp:SessionParameter Name="userid" SessionField="userid" Type="string" />
        ...
        <div class="panel panel-default">
        	<div class="panel-heading"><svg class="glyph stroked male user"><use xlink:href="#stroked-male-user"></use></svg><b><i>Your Sprints as a Team Member are: </i></b></div>
        </div>
        <br />
				...
				<div class="panel panel-orange panel-widget ">
					<div class="row no-padding">
					 ...
					 <asp:HyperLink ID="HyperLink1" runat="server" 
                                   NavigateUrl='<%# "~/Scrum/sprintpage.aspx?projectID="+Eval("projectID")+"&sprintID="+Eval("sprintID")%>'>
