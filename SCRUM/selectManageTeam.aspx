<%@ Page Language="C#" AutoEventWireup="true" CodeFile="selectManageTeam.aspx.cs" Inherits="selectManageTeam" %>
...
<body>
   ...
   <asp:SessionParameter Name="userid" SessionField="userid" Type="string" />
        ...
        <div class="panel panel-default">
        	<div class="panel-heading"><svg class="glyph stroked male user"><use xlink:href="#stroked-male-user"></use></svg><b><i>The Teams you are a member of are: </i></b></div>
        </div>
        <br />
				...
				<div class="panel panel-blue panel-widget ">
					<div class="row no-padding">
					 ...
					 <asp:HyperLink ID="HyperLink1" runat="server" 
                                   NavigateUrl='<%# "~/Scrum/ManageTeam.aspx?projectID="+Eval("projectID")%>'>
