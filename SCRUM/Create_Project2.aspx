<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Create_Project2.aspx.cs" Inherits="projects" %>
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
		 ...
		 <li><a href="register.aspx"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg> Register Page</a></li>
        </ul>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">		
		<div class="row">
			<ol class="breadcrumb">
				<li><a href="#"><svg class="glyph stroked-open-folder"><use xlink:href="#stroked-open-folder"></use></svg></a></li>
      ...
      <div class="row">
                    ...
                    <div class="panel-heading"><svg class="glyph stroked clipboard-with-paper"><use xlink:href="#stroked-clipboard-with-paper"></use></svg>Create a New Project</div>
					
				</div>

        <div class="panel-heading dark-overlay2"></div>

        <div class="form-group">

         
          <%--  <asp:SqlDataSource ID="ProjectDetails" runat="server" ConnectionString="dbconnect" SelectCommand="SELECT * FROM SCRUM_PROJECT WHERE projectID=@pID AND projectName=@name">
            ...
            <asp:TextBox ID="projectIDbox" runat="server"></asp:TextBox>
