            ...
            <div class="panel panel-default">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <svg class="glyph stroked clipboard-with-paper">
                            <use xlink:href="#stroked-clipboard-with-paper"></use></svg>Add Members to a Project Team</div>
                ...
                <asp:Panel ID="SearchResults" runat="server">
                    ...
                    <asp:ListView ID="Displaysearch" runat="server" DataSourceID="UserDetails">
                        <ItemTemplate>
                            ...
                            <asp:Image ID="image" runat="server" Style="width: 100px; height: 100px" ImageUrl='<%# "../" + Eval("imagepath")  %>' />
                            <br />
                            <b>First Name: </b>
                            ...
                            <br />
                            <asp:TextBox ID="chosenUserID" runat="server" Text='<%# Eval("userID") %>' Style="visibility: hidden"></asp:TextBox>
                            <%--Add "button"--%>
                            <br />
                            <asp:HyperLink ID="AddMemberLink" runat="server" class="btn btn-primary" NavigateUrl='<%# "CreateTeamAdd.aspx?userID=" + Eval("userID") + "&email=" + Eval("email") + "&name=" + Eval("firstName") + "&pname=" + Request.QueryString["projectName"].ToString() + "&projectID=" + Request.QueryString["projectid"].ToString() %>'>Add</asp:HyperLink></div>
                        ...
                        <EmptyDataTemplate>
                            <table runat="server" style="">
                                <tr>
                                    <td>No Team Members Returned.</td>
                                </tr>
                            </table>
                        </EmptyDataTemplate>
