<%@ Page Language="C#" AutoEventWireup="true" CodeFile="unassignedtaskaddupdate.aspx.cs" Inherits="unassignedtaskaddupdate" %>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <svg class="glyph stroked male user">
                                        <use xlink:href="#stroked-male-user"></use></svg><b><i>Select a Team Member below: </i></b></div>
                                ...
                                <asp:SqlDataSource ID="unassign" runat="server" ConnectionString='<%$ ConnectionStrings:dbconnect %>'
                                    SelectCommand="SELECT SCRUM_BACKLOG.ID, SCRUM_BACKLOG.asUser, SCRUM_BACKLOG.iWant, SCRUM_BACKLOG.soThat, SCRUM_BACKLOG.priority, SCRUM_BACKLOG.value, SCRUM_SPRINT_TASK.taskDetails
                FROM SCRUM_BACKLOG 
                INNER JOIN SCRUM_SPRINTBACKLOG ON SCRUM_BACKLOG.ID = SCRUM_SPRINTBACKLOG.backlogID 
                INNER JOIN SCRUM_PROJECT ON SCRUM_BACKLOG.projectID = SCRUM_PROJECT.projectID 
                INNER JOIN SCRUM_SPRINT_TASK ON SCRUM_BACKLOG.ID = SCRUM_SPRINT_TASK.backlogID
                WHERE (SCRUM_PROJECT.projectID = @ID) AND (SCRUM_SPRINT_TASK.userID =@Uid)">
                                ...
                                <asp:SqlDataSource ID="teammembers" runat="server" ConnectionString='<%$ ConnectionStrings:dbconnect %>' SelectCommand="SELECT [userID], [firstName] FROM [SCRUM_USERS]"></asp:SqlDataSource>

                                <asp:DropDownList ID="team" runat="server" DataSourceID="teammembers" DataTextField="firstName" DataValueField="userID"></asp:DropDownList>


                                <%-- SM - Update Button  --%>

                                <asp:Button ID="update" runat="server" Text="Assign" OnClick="update_Click" />
