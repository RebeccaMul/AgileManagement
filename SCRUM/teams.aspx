...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		</div><!--/.row--> <a href="selectCreateTeam.aspx"> 
			...
			<div class="panel panel-teal panel-widget ">
					<div class="row no-padding">
						<div class="col-sm-3 col-lg-5 widget-left">
							...
							<svg class="glyph male user"><use xlink:href="#stroked-male-user"></use></svg>
						</div> 
                       
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large">Add Members </div>
							<div class="text-muted"></div></a>
						</div>
                        
					</div>
				</div>
			</div>
                <a href="selectManageTeam.aspx"> 
        	<div class="col-xs-12 col-md-6 col-lg-3">
				<div class="panel panel-teal panel-widget ">
					<div class="row no-padding">
						<div class="col-sm-3 col-lg-5 widget-left">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large">Manage Team</div>
