<%@ Page Language="C#" AutoEventWireup="true" CodeFile="selectCreateTeam.aspx.cs" Inherits="selectCreateTeam" %>
...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">		
       ...
       <div class="row">
        ...
        <asp:SqlDataSource ID="ListProjects" runat="server" ConnectionString='<%$ ConnectionStrings:dbconnect %>' SelectCommand="SELECT * FROM SCRUM_PROJECT WHERE SCRUM_PROJECT.projectManager= @userid ">
   ...
   <asp:SessionParameter Name="userid" SessionField="userid" Type="string" />
        ...
        <div class="panel panel-default">
        	<div class="panel-heading"><svg class="glyph stroked male user"><use xlink:href="#stroked-male-user"></use></svg><b><i>The Teams you are Project Manager of, Click to add team members to project: </i></b></div>
        </div>
        <br />
				...
				<div class="panel panel-blue panel-widget ">
					<div class="row no-padding">
					 ...
					 <asp:HyperLink ID="HyperLink1" runat="server" 
                                   NavigateUrl='<%# "~/Scrum/CreateTeam.aspx?projectID="+Eval("projectID") + "&ProjectName=" + Eval("projectName")%>'>
